...
if __name__ == "__main__":
    ...
    for dataset in [train_set, test_set]:
        for train_row in jsonlines.open(dataset):
            relation_drugs = sorted([span['text'].lower() for span in train_row['spans']])
            processed_rows, relation_counts = process_document(train_row['sentence'], train_row['paragraph'], train_row['source'], relation_drugs, mask_one_drug_at_a_time)
